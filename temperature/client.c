...
void *sendingTemperature(void *pthread_data)
{
    FILE *fstream = NULL;
    char buff[1024];
    ...
    while (1)
    {
        ...
        if (NULL == (fstream = popen("cat /sys/bus/w1/devices/28-3c30690e64ff/w1_slave | grep t=", "r")))
        {
...
int main(int argc, char **argv)
{
    ...
    ret = pthread_create(&TemperatureMonitor, NULL, sendingTemperature, NULL);
    if (ret != 0)
    {
        printf("creating monitor error!\n");
        return 0;
    }
